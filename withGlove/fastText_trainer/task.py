...
#     data_url = 'gs://enrich_xingming/fast_text_data/beauty.csv'
    ...
    (train_x, train_y, eval_x, eval_y, NUM_OF_CLASS,EB_feature,MAX_NUM_WORDS) = ut.load_data(data_url,data_filename,args.job_dir,args.feature)
  ...
  # Create the Keras Model
    ...
    keras_model = md.create_keras_model(max_features, embedding_dims,maxlen,NUM_OF_CLASS,EB_feature)
...
#   # Train model
    ...
    keras_model.fit(
        ...
        validation_steps=1,
        verbose=1,
        callbacks=[ EarlyStopping(monitor='val_loss', patience=3), tensorboard_cb],
